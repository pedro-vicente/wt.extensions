...
public:
  ...
  //If a geometry has a commonly used identifier, 
  //that identifier should be included as a member of the geometry object with the name “id”.
  std::string id; 
};
...
public:
  ...
  std::vector<double> get_first(size_t idx_topo);
